...
/*
  $switchToggle.draggable({ containment: "parent", axis: "x" });

    $gameOffPos.droppable({
      tolerance: "intersect",
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left - 2 ;
    ...
    $game2Pos.droppable({
      ...
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left - 11 ;
          ui.draggable.animate({
              left: '+=' + left_end
          });
    ...
    $game3Pos.droppable({
      ...
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left - 22 ;
          ui.draggable.animate({
              left: '+=' + left_end
          });
          game = 1;
    ...
    $skill1Pos.droppable({
      ...
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left - 5;
          ui.draggable.animate({
              left: '+=' + left_end
          });
          skillLevel = 1;
    ...
    $skill2Pos.droppable({
      ...
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left - 3;
          ui.draggable.animate({
              left: '+=' + left_end
          });
          skillLevel = 2;
    ...
    $skill4Pos.droppable({
      ...
      drop: function(event, ui) {
        ...
        //Animate Drop Snap
          const drop_p = $(this).offset();
          const drag_p = ui.draggable.offset();
          const left_end = drop_p.left - drag_p.left + 1;
          ui.draggable.animate({
              left: '+=' + left_end
          });
          skillLevel = 4;
